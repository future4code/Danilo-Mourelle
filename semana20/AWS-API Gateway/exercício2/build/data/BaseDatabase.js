...
var BaseDatabase = /** @class */ (function () {
    ...
    BaseDatabase.desconnectDB = function () {
    ...
    BaseDatabase.prototype.convertTinyintToBoolean = function (value) {
        return value === 1;
    };
    BaseDatabase.prototype.convertBooleanToTinyint = function (value) {
        return value ? 1 : 0;
    };
    BaseDatabase.CONNECTION_KNEX = null;
    return BaseDatabase;
