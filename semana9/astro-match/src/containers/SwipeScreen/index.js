...
import { getNewProfile, choosePerson } from '../../actions/profiles'
...
const mapStateToProps = (state) => ({
  profileToSwipe: state.profiles.actualProfile
})

const mapDispatchToProps = (dispatch) => {
  return {
    goToMatchScreen: () => dispatch(updateCurrentPage('MatchScreen')),
    getProfileToSwipe: () => dispatch(getNewProfile()),
    chooseProfile: (id, chose) => dispatch(choosePerson(id, chose))
  }
}
